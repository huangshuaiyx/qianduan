    ...
    <el-form label-width="80px">
      ...
      <el-form-item label="缩略图">
        <el-upload
          ...
          action="http://127.0.0.1:9527/slfileup"
          :show-file-list="false"
          :on-success="slsuccess"
          name="sl"
        >
          <img v-if="imageUrl" :src="`http://127.0.0.1:9527${imageUrl}`" class="avatar" />
      ...
      <el-form-item label="轮播图">
        <el-upload
          class="upload-demo"
          action="http://127.0.0.1:9527/lbfileup"
          :file-list="fileList"
          list-type="picture"
      ...
      <!-- 提交 -->
      <el-form-item>
        <el-button type="danger" @click="$router.push({'name':'splist'})">返回</el-button>
...
export default {
  ...
  methods: {
    ...
    lbsuccess(res) {
      this.fileList.push({
        name: res.imgurl,
        url: `http://127.0.0.1:9527${res.imgurl}`
      });
    },
    add() {
